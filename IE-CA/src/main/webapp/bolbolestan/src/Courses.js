...
class Courses extends React.Component {
    ...
    getInfo() {
        ...
        fetch('http://localhost:8080/students/me/schedule', {
            headers: {
            ...
            .then(data => {
                ...
                fetch('http://localhost:8080/students/me/totalPassedUnits', {
                    headers: {
                        "authorization": localStorage.getItem('token')
                    }
                })
    ...
    finalize() {
        this.setState(() => ({ selectedCourseLoading: true }));
        fetch('http://localhost:8080/students/me/schedule/courses/finalize', {
            method: 'POST',
            headers: {
                "authorization": localStorage.getItem('token')
            }
    ...
    handleAdd(code, classCode) {
        this.setState(() => ({ selectedCourseLoading: true }));
        fetch("http://localhost:8080/students/me/schedule/courses/" + code + "/" + classCode, {
            method: 'POST',
            headers: {
    ...
    handleReset() {
        this.setState(() => ({ selectedCourseLoading: true }));
        fetch("http://localhost:8080/students/me/schedule/courses/reset", {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
    ...
    showAsli(event) {
        ...
        fetch('http://localhost:8080/courses?type=Asli', {
            headers: {
                'authorization': localStorage.getItem('token')
            }
        })
    ...
    showPaye(event) {
        event.preventDefault();
        this.setState(() => ({ filteredCourseLoading: true }));
        fetch('http://localhost:8080/courses?type=Paaye', {
            headers: {
                'authorization': localStorage.getItem('token')
            }
        })
    ...
    showUmumi(event) {
        event.preventDefault();
        this.setState(() => ({ filteredCourseLoading: true }));
        fetch('http://localhost:8080/courses?type=Umumi',{
            headers: {
                'authorization': localStorage.getItem('token')
            }
        })
    ...
    showAll(event) {
        event.preventDefault();
        this.setState(() => ({ filteredCourseLoading: true }));
        fetch('http://localhost:8080/courses?type=', {
            headers: {
                'authorization': localStorage.getItem('token')
            }
        })
    ...
    showTakhasosi(event) {
        event.preventDefault();
        this.setState(() => ({ filteredCourseLoading: true }));
        fetch('http://localhost:8080/courses?type=Takhasosi', {
            headers: {
                'authorization': localStorage.getItem('token')
            }
        })
    ...
    handleSearch(event) {
        event.preventDefault();
        this.setState(() => ({ filteredCourseLoading: true }));
        fetch('http://localhost:8080/courses/search?keyword=' + this.state.searchKey, {
            headers: {
                'authorization': localStorage.getItem('token')
            }
        })
